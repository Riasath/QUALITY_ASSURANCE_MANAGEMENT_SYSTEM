        ...
        <div class="row">
            <div class ="span12">
                <div class="panel panel-success">
                    ...
                    <center><h2>IQACMS Head Verification</center>
                </div>
            </div>
        </div>
    </div>
...
echo form_open_multipart('Head/Submission/'); ?>
...
<?php
  $complete="NULL";
  foreach ($DepertmentTeacherList->result() as $row) {
                      
                                  $FullName = $row->FullName;
                                  $status = $row->Status;
        
        $edit_url = base_url()."Iqac/LoadTeacherData/".$row->UserId;
...
<div class="container">
			<br><a href="<?php echo base_url('Iqac/LoadDeancData/'.$HeadTempId) ?>" role="button" class="btn btn-primary btn-large justcause">Back</a> &nbsp;
