...
<?php
  ...
  foreach ($TeacherResult->result() as $row) {
        ...
        $edit_url = base_url()."iqac/view/".$row->StoreId;
...
<div class="container">
            ...
            <br><a href="<?php echo base_url('iqac/LoadHeadData/'.$HeadTempId) ?>" role="button" class="btn btn-primary btn-large justcause">Back</a> &nbsp;
