...
<?php
  ...
  foreach ($DepertmentTeacherList->result() as $row) {
        ...
        $edit_url = base_url()."dean/loadteacherdata/".$row->UserId;
...
<div class="container">
			<br><a href="<?php echo base_url('dean/loaddeandata') ?>" role="button" class="btn btn-primary btn-large justcause">Back</a> &nbsp;
