        ...
        <div class="row">
            <div class ="span12">
                <div class="panel panel-success">
                    ...
                    <center><h2>IQACMS Teachers PANEL</center>
                </div>
            </div>
        </div>
    </div>
...
<?php
  ...
  foreach ($TeacherResult->result() as $row) {
        ...
        $edit_url = base_url()."teacher/view/".$row->StoreId;
...
<?php
  ...
  {
    ?>
    <button type="submit" class="btn btn-primary justcause"><?php echo form_submit('submit', 'Submit', 'class="btn btn-primary"'); ?></button>
    <?php
  }
?>
