        ...
        <div class="row">
            <div class ="span12">
                <div class="panel panel-success">
                    ...
                    <center><h2>IQACMS Dean Verification</center>
                </div>
            </div>
        </div>
    </div>
...
<?php
  ...
  foreach ($DepertmentTeacherList->result() as $row) {
        ...
        $edit_url = base_url()."Iqac/LoadHeadData/".$row->UserId;
...
<div class="container">
			<br><a href="<?php echo base_url('Iqac/LoadIqacData') ?>" role="button" class="btn btn-primary btn-large justcause">Back</a> &nbsp;
