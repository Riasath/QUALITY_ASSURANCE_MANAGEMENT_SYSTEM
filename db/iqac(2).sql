...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2016 at 10:44 AM
...
(4, 2, 1, 1, 1, 0, 23, 4, 4, 3, 0, 'No', 'No', './store/upload_MidTermExam/FH-CSE311-A-2014-Summer.pdf', './store/upload_FinalTermExam/FH-CSE311-A-2014-Summer.pdf', './store/upload_Attandence/FH-CSE311-A-2014-Summer.pdf', 'http://localhost:8080/iqac/Teacher/view/2', 0),
(5, 2, 1, 2, 1, 0, 0, 2, 2, 2, 0, 'Yes', 'Yes', '', '', '', '', 0),
(6, 2, 1, 3, 1, 0, 0, 2, 2, 2, 0, 'Yes', 'Yes', '', '', '', '', 0),
(7, 2, 1, 4, 1, 0, 0, 2, 2, 2, 0, 'Yes', 'Yes', '', '', '', '', 0),
(8, 2, 1, 5, 1, 0, 0, 0, 0, 0, 0, '', '', '', '', '', '', 0);
...
--
ALTER TABLE `usertyperelation`
MODIFY `UserTypeRelationId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
